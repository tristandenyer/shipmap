...
describe('detectRenderingStrategy', () => {
  it('detects Static (default)', async () => {
    const result = await detectRenderingStrategy(
      join(fixtures, 'nextjs-app-router/app/page.tsx'),
    );
  ...
  it('detects Client component', async () => {
    const result = await detectRenderingStrategy(
      join(fixtures, 'nextjs-app-router/app/dashboard/page.tsx'),
    );
  ...
  it('detects SSR from cookies() usage', async () => {
    const result = await detectRenderingStrategy(
      join(fixtures, 'nextjs-app-router/app/settings/page.tsx'),
    );
  ...
  it('detects ISR from revalidate', async () => {
    const result = await detectRenderingStrategy(
      join(fixtures, 'nextjs-app-router/app/(marketing)/about/page.tsx'),
    );
  ...
  it('detects SSG from getStaticProps', async () => {
    const result = await detectRenderingStrategy(
      join(fixtures, 'nextjs-pages-router/pages/index.tsx'),
    );
  ...
  it('detects SSR from getServerSideProps', async () => {
    const result = await detectRenderingStrategy(
      join(fixtures, 'nextjs-pages-router/pages/dashboard/index.tsx'),
    );
    expect(result).toBe('SSR');
  });
